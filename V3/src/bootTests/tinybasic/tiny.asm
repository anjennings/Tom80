...
SerialPort	EQU	0x06		;This is for your I/0
...
INIT:
	; Set up Z180 MMU before using the stack
	LD B, 0x00

	LD A, 0xE1	; Set Common Bank 1 to physical top of RAM
	LD C, 0x38	; MMU CBR
	OUT (C), A

	LD A, 0x7F	; Set Bank Area to physical bottom of RAM
	LD C, 0x39	; MMU BBR
	OUT (C), A

	LD A, 0xF1	; 4K Common at top of RAM, 4K Common at start of ROM
	LD C, 0x3A	; MMU CBAR
	OUT (C), A
...
SERIAL_INIT:
	...
	; Init ASCI A
	LD B, 0x00
	LD A, 0x00	; 0000 0000 	7 can be changed, drive capability pins can be changed
	LD C, 0x1F	; CCR (CPU Control Reg)
	OUT (C), A
	...
	LD A, 0x00	; 00?0 0000	Pin 5,3-0 relies on ASEXT 
	LD C, 0x02	; CNTLB0
	OUT (C), A

	LD A, 0x00
	LD C, 0x04	; STAT0, mostly read only
	...
	LD A, 0x3F	; 0011 1111	At lower clock speeds Multiplier can be set
	LD C, 0x1E	; Clock Multiplier Reg
	OUT (C), A	

...
BOOT_MSG:
DEFB		12, CR, LF, 'CP/M 2.2 FOR TOM80', CR, LF, '57k RAM', CR, LF, 'BUILD 2021-07-08', CR, LF, 0, 0
...
;Targets a non-existant "tape punch"       
PUNCH_:
        RET
...
;Set the track in C (or maybe BC?)
SETSEC_:
        PUSH AF
        LD A, PROP_SETSEC
        CALL PIO_SEND_CMD
...
;AKA LISTST, Return status of current printer device.
PRSTAT_:
        LD A, 0xFF
        RET

...
;////////////////////////////////////////////////////////
COLOR_NORMAL:
db ASCII_ESC, ASCII_LBR, "37", ASCII_SEMI, "40", ASCII_TER, EOT

COLOR_INVERT:
db ASCII_ESC, ASCII_LBR, "30", ASCII_SEMI, "47", ASCII_TER, EOT

COLOR_WARN:
db ASCII_ESC, ASCII_LBR, "33", ASCII_SEMI, "40", ASCII_TER, EOT

COLOR_ERR:
db ASCII_ESC, ASCII_LBR, "31", ASCII_SEMI, "40", ASCII_TER, EOT

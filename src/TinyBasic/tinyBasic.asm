...
;COMPUTER SPECIFIC ROUTINES.
        ...
        UART_DHR EQU        0 ;UART Data R/W register
        UART_IER EQU        1 ;Interrupt Enable Register
        UART_IFR EQU        2 ;Interrupt ID Reg (READ), FIFO Control Reg (WRITE)
        UART_LCR EQU        3 ;Line Control Register
        UART_MCR EQU        4 ;Modem Control
        UART_LSR EQU        5 ;Line Status Register
        UART_MSR EQU        6 ;Modem Status (Unused)
        UART_SCR EQU        7 ;Arbitrary data can be stored here
...
UART_SET_LINE_CONTROL:
    PUSH AF
    LD A, 3h         ;8 Bit word, 1 stop, no parity
    OUT (UART_LCR), A
    POP AF
    RET
